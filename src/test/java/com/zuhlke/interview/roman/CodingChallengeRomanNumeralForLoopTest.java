...
public class CodingChallengeRomanNumeralForLoopTest {

	private CodingChallengeRomanNumeralForLoop challenge;

	@BeforeEach
	public void beforeEach() {
		this.challenge = new CodingChallengeRomanNumeralForLoop();
	}
